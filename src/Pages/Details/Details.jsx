...
const Details = () => {
    ...
    const { _id,
        title,description,category,price,image} = addToCart;
  ...
  const handleAddToCart =()=>{
    ...
    <div className=" flex-1 space-y-10 text-center m-4">
      <h2 className="card-title border border-black shadow-xl">Product: <span className="font-serif text-orange-500"> {title}</span></h2>
      <p className="border border-black">Category: <span className="font-bold">{category}</span></p>
      ...
      <p className="border border-black"> <span className="font-bold text-blue-700">{user?.displayName}</span> </p>
